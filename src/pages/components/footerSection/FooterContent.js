...
const FooterContent = () => {
  return (
    <div className="flex flex-col px-[20px] sm:px-[20px] md:px-[55px] lg:px-[200px]">
      <div className="flex flex-col justify-between items-center md:flex-row sm:gap-12">
        ...
        <div className="flex py-8 flex-col justify-center items-center text-text-header-dark-color md:items-start w-[300px]sm:w-[148px] sm:pl-[30px]">
          <div className="font-bold text-2xl">Links</div>
          <Link to="#" className="mt-7 hover:text-orange-700">
            FAQs
          </Link>
          <Link to="#" className="mt-2 mb-2 hover:text-orange-700">
            About
          </Link>
        ...
        <div className="flex py-8 flex-col justify-center items-center text-text-header-dark-color md:items-start">
