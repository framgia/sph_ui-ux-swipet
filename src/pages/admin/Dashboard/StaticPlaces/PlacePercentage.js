...
const PlacePercentage = () => (
  <div className='flex gap-[15px]'>
    <li className='flex w-[150px] flex-col items-center justify-center border-r-2 text-[12px] text-[#A3AED0]'>
    ...
    <li className='flex w-[150px] flex-col items-center justify-center text-[12px] text-[#A3AED0]'>
      <div className='flex items-center justify-center gap-[5px]'>
